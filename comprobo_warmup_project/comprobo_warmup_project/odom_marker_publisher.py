...
class OdomMarkerPublisher(Node):
    def __init__(self):
        super().__init__('odom_marker_publisher') #node name ros2 uses
    ...
    def publish_marker(self):
        ...
        marker.header.frame_id = "odom"; # puts marker in odom frame
